function Feature({ title, imageUrl, description }) {
    return (
      <div className="flex flex-col items-stretch my-4 max-md:w-full max-md:ml-0 max-sm:-my-2">
        <div className="bg-red-300 shadow-cs-5md flex w-[80vw] md:w-[36vw] lg:w-[24vw] grow flex-col mx-auto px-11 py-14 rounded-2xl max-md:mt-10 max-md:px-5 max-sm:py-8 max-sm:w-[75vw]">
